        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3 sm:gap-4 md:gap-8 px-4 sm:px-6 md:px-16 py-4 sm:py-6 md:py-10">
          ...
          <div className="sm:col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-2 mt-2 sm:mt-3 md:mt-5">
              <a href="https://www.linkedin.com/company/advent-management-consulting-services/posts/?feedView=all" className="text-white hover:text-gray-300 transition-colors" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2 md:space-y-3 text-[10px] sm:text-xs md:text-sm text-gray-300">
              <li><a href="https://adventmcs.com/" className="hover:text-white transition-colors">Visit our Official Site</a></li>
